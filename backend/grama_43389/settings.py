"""
Django settings for grama_43389 project.
...
WSGI_APPLICATION = 'grama_43389.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "grama_43389 API",
    "DESCRIPTION": "API documentation for grama_43389 App",
    "VERSION": "v1",
}
